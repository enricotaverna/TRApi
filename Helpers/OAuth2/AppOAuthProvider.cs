namespace WebApiOauth2.Helper_Code.OAuth2
{
    ...
    public class AppOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            DataRow dr = Database.GetRow("SELECT * FROM Persons WHERE userId = " + Database.FormatStringDb(usernameVal) + " AND password = " + Database.FormatStringDb(passwordVal) + " AND active=1");
            ...
            var userInfo = new { username = usernameVal , password = passwordVal };
